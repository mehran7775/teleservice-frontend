      ...
      <div class="panel" v-if="userDatas.role==='clerk'">
        <div class="panel-right order-1 order-sm-0">
          ...
          <div class="picUser">
            ...
            >
              <input type="file" ref="picture" @change="setProfileExpert"/>
            </div>
          </div>
          <div class="nav-info">
            <ul>
            ...
            <div>
              <div>
                <div class="float-right">
                  <img class="m-3 cursor-pointer" width="32" height="32" src="../../../assets/images/icons/edit-property-32.png" alt=""
                       @click="showPanelEdit=!showPanelEdit" title="ویرایش">
                </div>
              </div>
              <div>
                  ...
                  <div class="mt-4" v-if="showPanelEdit">
                    <div class="rowMy">
                      <div class="col-12 col-sm-6 form-inline">
                        ...
                        <input
                          id="nameClerk"
                          type="text"
                          :class="[ validates.isInvalidated.name ? 'is-invalid' :null , validates.isValidated.name ? 'is-valid':null,
                      ...
                      <div class="col-12 col-sm-6 form-inline">
                        ...
                        <input
                          type="text"
                          :class="[ validates.isInvalidated.username ? 'is-invalid' :null , validates.isValidated.username ? 'is-valid':null,
                       'form-control w-75 mr-2']"
                          id="usernameClerk"
                          name="usernameClerk"
                          ref="usernameClerk"
                          v-model="userDatas.username"
                          @input="validateClerk(userDatas.username,'usernameClerk')"
                        />
                      </div>
                    </div>
                    <br>
                    <div class="rowMy">
                      <div class="col-12 col-sm-6 form-inline">
                        ...
                        <input type="email"
                               :class="[ validates.isInvalidated.email ? 'is-invalid' :null , validates.isValidated.email ? 'is-valid':null,
                       'form-control w-75 mr-2']"
                               id="emailClerk"
                               name="emailClerk"
                               ref="emailClerk"
                    ...
                    <div class="rowMy">
                      <div class="col-12 col-sm-6 form-inline">
                        ...
                        <input
                          id="meliNumberClerk"
                          type="text"
                          :class="[ validates.isInvalidated.meliNumber ? 'is-invalid' :null , validates.isValidated.meliNumber ? 'is-valid':null,
                       'form-control w-50 mr-2']"
                          ref="meliNumberClerk"
                          v-model="userDatas.meliNumber"
                          @input="validateClerk(userDatas.meliNumber,'meliNumberClerk')"
                        />
                      </div>
                      <br>
                      <div class="col-12 col-sm-6 form-inline">
                    ...
                    <div class="rowMy">
                      <div class="col-12 col-sm-6 form-inline">
                        <label for="expertFileClerk">بارگزاری مدرک تخصصی صاحب رادیولوژی:</label>
                        <input
                          type="file"
                      ...
                      <div class="col-12 col-sm-6 form-inline">
                        <label for="centerFileClerk">بارگزاری پروانه تاسیس مرکز رادیولوژی:</label>
                        <input
                          type="file"
                          class="form-control-file files mr-2"
                    ...
                    <div class="rowMy">
                      ...
                      <div class="col-12 col-sm-6 form-inline">
                        ...
                        <input
                          type="text"
                          id="streetClerk"
                          :class="[ validates.isInvalidated.street ? 'is-invalid' :null , validates.isValidated.street ? 'is-valid':null,
                       'form-control w-50 mr-2']"
        ...
        <div class="position-relative m-1 ml-4 order-0 order-sm-2">
          <img @click="back()" class="icon-back" src="../../../assets/images/icons/arrow-115-32.png" alt="">
        </div>
      </div>
        ...
        <div class="panel-left order-2 order-sm-1">
          <div style="width:100%">
            ...
            <div>
              <div>
                <div class="float-right">
                  <img class="m-3 cursor-pointer" width="32" height="32" src="../../../assets/images/icons/edit-property-32.png" alt="" @click="showPanelEdit=!showPanelEdit">
<!--                  <button-->
                    ...
                    <div class="rowMy">
                      ...
                      <div class="col-12 col-sm-6 form-inline">
                       ...
                       'form-control w-75 mr-2']"
                          ...
                          ref="usernameExpert"
                          v-model="userDatas.username"
                          @input="validateExpert(userDatas.username,'usernameExpert')"
                        />
                      </div>
                    </div>
                    <br>
                    ...
                    <div class="rowMy">
                      <div class="col-12 col-sm-6 form-inline">
                       ...
                       'form-control w-50 mr-2']"
                          ...
                          v-model="userDatas.meliNumber"
                          @input="validateExpert(userDatas.meliNumber,'meliNumberExpert')"
                        />
                      </div>
                      <br>
                      <div class="col-12 col-sm-6 form-inline">
                    ...
                    <div class="rowMy">
                      ...
                      <div class="col-12 col-sm-6 form-inline">
                       ...
                       'form-control w-50 mr-2']"
                          v-model="userDatas.street"
                          ref="streetExpert"
                          @input="validateExpert(userDatas.street,'streetExpert')"
                        />
                      </div>
                    </div>
                    <input
...
<script>
  ...
  export default {
    ...
    beforeCreate () {
      ...
      // this.$store.dispatch('showDashboard',this.$route.params.id)
    },
    created () {
    ...
    methods:{
      validateClerk (x=null,id=null) {
        ...
        if (x===''){
          ...
          switch (x) {
            ...
            case this.userDatas.username: {
              let res = x.match(/^[a-zA_Zضصثقفغعهخحجچپشسیبلاتنمکگظطزرذدئو0-9]{4,15}$/gi)
              if (res) {
            ...
            case this.userDatas.meliNumber: {
              ...
              if (res) {
                ...
                this.$store.dispatch('changeValidate', 'falseMeliNumberClerkEdit')
        ...
        if ((this.userEditValidate.okName===0 || this.userEditValidate.okName===1)&&(this.userEditValidate.okUserName===0 || this.userEditValidate.okUserName===1)&&
          (this.userEditValidate.okEmail===0 || this.userEditValidate.okEmail===1)&&
          (this.userEditValidate.okMeliNumber === 0 || this.userEditValidate.okMeliNumber === 1) && (this.userEditValidate.okMeliFile === 0 || this.userEditValidate.okMeliFile === 1) &&
          (this.userEditValidate.okCenterFile === 0 || this.userEditValidate.okCenterFile === 1)
      ...
      validateExpert(x=null,id=null){
        this.userExpert.city=this.$refs.cityExpert.value
        if (typeof this.$refs.madrakFile!== 'undefined'){
          this.userExpert.madrakFile = this.$refs.madrakFile.files[0]
        }
        if (typeof this.$refs.meliFileExpert!== 'undefined'){
          this.userExpert.meliFile = this.$refs.meliFileExpert.files[0]
        }
        if (x===''){
          let el=document.getElementById(id)
          el.classList.remove("is-invalid")
        ...
        if ((this.userEditValidate.okName===0 || this.userEditValidate.okName===1)&&(this.userEditValidate.okUserName===0 || this.userEditValidate.okUserName===1)&&
          (this.userEditValidate.okEmail===0 || this.userEditValidate.okEmail===1)&&
          (this.userEditValidate.okMeliNumber === 0 || this.userEditValidate.okMeliNumber === 1) && (this.userEditValidate.okMeliFile === 0 || this.userEditValidate.okMeliFile === 1)
          && (this.userEditValidate.okMadrakFile === 0 || this.userEditValidate.okMadrakFile === 1) && (this.userEditValidate.okStreet === 0 || this.userEditValidate.okStreet === 1)
          && (this.userExpert.city)){
          this.userExpert.name=this.$refs.nameExpert.value
          this.userExpert.username=this.$refs.usernameExpert.value
          this.userExpert.email=this.$refs.emailExpert.value
          this.userExpert.meliNumber=this.$refs.meliNumberExpert.value
          this.userExpert.street=this.$refs.streetExpert.value
          this.btnStatus = false
        } else {
          this.btnStatus = true
        }
      ...
      update(name){
        let filesName=[];
        this.userDatas.files.meliFile?filesName['meliFile']=this.userDatas.files.meliFile:null
        this.userDatas.files.centerFile?filesName['centerFile']=this.userDatas.files.centerFile:null
        this.userDatas.files.expertFile?filesName['expertFile']=this.userDatas.files.expertFile:null
        this.userDatas.files.madrakFile?filesName['madrakFile']=this.userDatas.files.madrakFile:null
        // filesName.toString()
        // vm.$set(vm.items, indexOfItem, newValue)
        // Vue.set(arr,meliFile,this.userDatas.files.meliFile)
        filesName=Object.assign({},filesName)
        if (name==='clerk'){
          this.$store.dispatch('update_user', {
            user:this.user,
            name_files:filesName,
            id:this.$route.params.id
          })
        }else if (name==='expert'){
          let arr=[]
          this.userDatas.files.meliFile?arr['meliFile']=this.userDatas.files.meliFile:null
          this.userDatas.files.centerFile?arr['centerFile']=this.userDatas.files.centerFile:null
          this.userDatas.files.expertFile?arr['expertFile']=this.userDatas.files.expertFile:null
          this.userDatas.files.madrakFile?arr['madrakFile']=this.userDatas.files.madrakFile:null
          this.$store.dispatch('update_user', {
            user:this.userExpert,
            name_files:arr,
            id:this.$route.params.id
          })
        }

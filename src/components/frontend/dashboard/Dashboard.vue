              ...
              <div class="w-25" v-show="alerts.update.default">
                <div class="alertUpdate bg-success">
                  ...
                  <div>
                    <span
                      class="close"
                      @click="this.$store.commit('change_alerts','falseUpdate')"
                    >&times;</span>
                  </div>
                </div>
              </div>
              ...
              <div class="rowMy">
                <div class="col-12 col-sm-6 form-inline">
                  ...
                  <input
                    type="text"
                    id="meliNumberExpert"
                    :class="[ validatesExpert.isInvalidated.meliNumber ? 'is-invalid' :null , validatesExpert.isValidated.meliNumber ? 'is-valid':null,
                       'form-control w-50 mr-2']"
                    v-model="formExpert.meliNumber"
                    @input="checkValidateExpert(formExpert.meliNumber,'meliNumber')"
                  />
                </div>
                <br>
                <div class="col-12 col-sm-6 form-inline">
              ...
              <div class="rowMy">
                ...
                <div class="col-12 col-sm-6 form-inline">
                  ...
                  <input
                    type="text"
                    id="streetExpert"
                    :class="[ validatesExpert.isInvalidated.street ? 'is-invalid' :null , validatesExpert.isValidated.street ? 'is-valid':null,
                       'form-control w-50 mr-2']"
    ...
    methods: {
      ...
      checkValidate (x=null,id=null) {
        ...
        if (this.formClerk.centerFile && this.formClerk.meliFile){
          if (this.formClerk.meliFile['type'] === 'image/jpeg' && this.formClerk.centerFile['type'] === 'application/pdf'){
            status=true
            if (this.formClerk.expertFile ) {
              if (this.formClerk.expertFile['type'] === 'application/pdf'){
                status=true
        ...
        this.btnStatus = !(this.validates.isValidated.meliNumber && this.validates.isValidated.street
          && this.formClerk.city && status);
      },
      checkValidateExpert (x=null,id=null) {
        ...
        if (this.formExpert.madrakFile && this.formExpert.meliFile){
          if (this.formExpert.meliFile['type'] === 'image/jpeg' && this.formExpert.madrakFile['type'] === 'application/pdf'){
            status2=true
          }else {
            status2=false
          }
        ...
        this.btnStatusExpert = !(this.validatesExpert.isValidated.meliNumber && this.validatesExpert.isValidated.street
          && this.formExpert.city && status2);
      },
      fullRegisterClerk () {
